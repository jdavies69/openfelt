...
Supported release targets are Linux x86_64, Windows x86_64, macOS Apple Silicon, and macOS Intel. A release install does not need Rust, Cargo, or a source checkout.
